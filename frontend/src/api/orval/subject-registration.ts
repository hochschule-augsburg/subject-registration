...
/**
 * @summary Get an active registration window
 */
export const getActiveRegistrtionWindow = (
    
 ) => {
      return customInstance<RegistrationWindowTO>(
      {url: `/api/registration_window/active`, method: 'get'
    },
      );
    }
  

export const getGetActiveRegistrtionWindowQueryKey = () => [`/api/registration_window/active`];

    
export type GetActiveRegistrtionWindowQueryResult = NonNullable<AsyncReturnType<typeof getActiveRegistrtionWindow>>
export type GetActiveRegistrtionWindowQueryError = ErrorType<unknown>

export const useGetActiveRegistrtionWindow = <TData = AsyncReturnType<typeof getActiveRegistrtionWindow>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<AsyncReturnType<typeof getActiveRegistrtionWindow>, TError, TData>, }

  ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } => {

  const {query: queryOptions} = options || {}

  const queryKey = queryOptions?.queryKey ?? getGetActiveRegistrtionWindowQueryKey();

  

  const queryFn: QueryFunction<AsyncReturnType<typeof getActiveRegistrtionWindow>> = () => getActiveRegistrtionWindow();

  const query = useQuery<AsyncReturnType<typeof getActiveRegistrtionWindow>, TError, TData>(queryKey, queryFn, queryOptions)
...
export const getRegistration = (
      ...
      return customInstance<RegistrationTO>(
      {url: `/api/registration/bystudent`, method: 'get'
    },
      );
    }
  

export const getGetRegistrationQueryKey = () => [`/api/registration/bystudent`];
...
export const useGetRegistration = <TData = AsyncReturnType<typeof getRegistration>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<AsyncReturnType<typeof getRegistration>, TError, TData>, }
  ...
  const queryFn: QueryFunction<AsyncReturnType<typeof getRegistration>> = () => getRegistration();

  const query = useQuery<AsyncReturnType<typeof getRegistration>, TError, TData>(queryKey, queryFn, queryOptions)
